...
public class BitcoindeOrderBookTest {
  ...
  public void testBitcoindeOrderBook()
    ...
    assertEquals("bla", orders[0].tradingPartnerInformation.userName);
    assertEquals("gold", orders[0].tradingPartnerInformation.trustLevel);
    assertEquals(new Integer(99), orders[0].tradingPartnerInformation.rating);
    assertEquals(true, orders[0].tradingPartnerInformation.isKycFull);
    assertEquals("Sparkasse", orders[0].tradingPartnerInformation.bankName);
    assertEquals("HASPDEHHXXX", orders[0].tradingPartnerInformation.bic);
    assertEquals("DE", orders[0].tradingPartnerInformation.seatOfBank);
    assertEquals(new Integer(52), orders[0].tradingPartnerInformation.amountTrades);
